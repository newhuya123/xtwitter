...
<div id="main_left">
<form method="post" id="f_twitter" action="main.php" >
<textarea id="message" name="message"></textarea>
<input type="submit" id="btn3" value="推特">
<input type="hidden" id="tid" name="tid">
</p>
</form>
<div id="loading" style="display:none;"><img src="image/loading.gif" alt="Loading..." /></div>  
<ul>
<?
